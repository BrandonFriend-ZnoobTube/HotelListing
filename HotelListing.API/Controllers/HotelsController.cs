...
public class HotelsController : ControllerBase
{
	...
	{
		if (id != updateHotelDO.Id) { return BadRequest(); }
		...
		try { await _hotelsRepository.UpdateAsync(hotel); }
	...
	async Task<bool> HotelExists(int id) => await _hotelsRepository.Exists(id);
}