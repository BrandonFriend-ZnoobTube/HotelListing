...
public class CountriesController : ControllerBase
{
	...
	public async Task<ActionResult<PagedResult<GetCountryDO>>> GetCountriesPaged(
	...
	{
		if (id != updateCountryDO.Id) { return BadRequest(); }

		try { await _countriesRepository.UpdateAsync(id, updateCountryDO); }
	...
	async Task<bool> CountryExists(int id) => await _countriesRepository.Exists(id);
}